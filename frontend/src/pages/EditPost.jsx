...
const EditPost = () =>{
    ...
    <Navbar/>
        ...
        <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
            ...
            {/*Categories below here*/}
            <div className="flex flex-col">
                <div className="flex items-center space-x-4 md:space-x-8">
                    <input value={tag} onChange={(e)=>setTag(e.target.value)} className="px-4 py-2 outline-none" placeholder="Enter post category" type="text"/>
            ...
            {/*Categories above here*/}

            <textarea onChange={(e)=>setDecs(e.target.value)} value={desc} rows={15} cols={30} className="px-4 py-2 outline-none" placeholder="Enter post description"/>
